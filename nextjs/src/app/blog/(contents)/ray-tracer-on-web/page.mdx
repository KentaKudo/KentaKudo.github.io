...
import { RayTracerCanvas } from "./RayTracerCanvas";
...
import materialsImageSrc from "./materials.png";
...
import rayImageSrc from "./ray.png";
...
import canvasApiImageSrc from "./canvas-api.png";
