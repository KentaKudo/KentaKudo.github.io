...
import eyeCatcheImageSrc from "~/images/laser.jpg";

{/* prettier-ignore */}
<EyeCatch src={eyeCatcheImageSrc} alt="batch of doughnuts">
  Photo by <a href="https://unsplash.com/@clyde_he?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Clyde He</a> on <a href="https://unsplash.com/s/photos/light?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
</EyeCatch>
