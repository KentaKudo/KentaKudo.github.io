...
eyeCatch:
  src: ~/images/jonathan-farber-6jpdeeA2GBU-unsplash.jpg
  alt: batch of doughnuts
  credit: Photo by <a href="https://unsplash.com/@farber?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Jonathan Farber</a> on <a href="https://unsplash.com/photos/6jpdeeA2GBU?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>
...
# {meta.filter((record) => 'title' in record).pop().title}

import { PublishedAt } from "~/components/PublishedAt";

<PublishedAt {...attributes.componentProps.PublishedAt} />

import { EyeCatch } from "~/components/EyeCatch";
import eyeCatcheImageSrc from "~/images/jonathan-farber-6jpdeeA2GBU-unsplash.jpg";

{/* prettier-ignore */}
<EyeCatch src={eyeCatcheImageSrc} alt="batch of doughnuts">
  Photo by <a href="https://unsplash.com/@farber?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Jonathan Farber</a> on <a href="https://unsplash.com/photos/6jpdeeA2GBU?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>
</EyeCatch>
...
<aside>
  <p>
    <a href="https://open.spotify.com/show/0J8LZwfrGB9BJLihy4Ldb1">
      London Tech Talk
    </a>
    というポッドキャストを運営している
    <a href="https://twitter.com/tommyasai">@tommyasai</a> さん・
    <a href="https://twitter.com/kenwagatsuma">@kenwagatsuma</a> さん主催で DDIA
    の輪読会が行われており、それに向けて DDIA を読んでいるのでその際のまとめです。今回は第
    10 章。
  </p>
  <p>
    理解したこと、考えたことをそのまま書き落としていくので読み物としては読みづらいかと思いますがその点は悪しからず。
  </p>
</aside>
